...
abstract class $PersonCopyWith<$Res> {
  ...
  @useResult
  $Res call({String firstName, String lname, int age});
}
...
class _$_Person implements _Person {
  const _$_Person(
      {required this.firstName, required this.lname, required this.age});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, firstName, lname, age);
